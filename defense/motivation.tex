...
% vertical axis
\draw[->,invisible] (0,0) -- (0,4) node[anchor=east,rotate=90,yshift=1ex,xshift=5ex] {Question Coverage};
...
\begin{center}
\textcolor<1-2>{white}{\textbf{This Thesis:} Formal reasoning with text over large corpora}
...
% vertical axis
\draw[->,visible on=<2->] (0,0) -- (0,4) node[anchor=east,rotate=90,yshift=1ex,xshift=5ex] {Question Coverage};
