...
\begin{center}
\hh{Additive updates on $f_y(x)$ directly}
\end{center}
\end{frame}
...
\hh{Faster Search = Deeper Reasoning} 
\begin{itemize}
...
My Thesis                       & 52                & \only<4->{51} \\
\hline
\pause
IR Baseline (More Data)         & 62                & \only<4->{58} \\
More Data + My Thesis           & \textbf<3-4>{65}  & \only<4->{\textbf<4>{61}} \\
\hline
\pause
\pause
My Thesis + \bell + \whistle   & \textbf{74}        & \textbf{67} \\
\hline
\end{tabular}
\pause
\vspace{2ex}
