...
% Natural Logic
This thesis focuses a fair bit on natural logic.
...
Many parts of this thesis are reminiscent of question answering tasks.
...
For example, \newcite{2005zettlemoyer-semantics} and \newcite{key:2011liang-semantics} 
...
\newcite{2005zettlemoyer-semantics} approaches the problem by learning a synchronous
