...
In this chapter, we construct a system for open information extraction (open IE), which will also
  serve to segment a long sentence into atomic propositions suitable to be a premise set for NaturalLI.
We will revisit the introduction of this open IE system into NaturalLI in the next chapter.
