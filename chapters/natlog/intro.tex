...
% Outline
%
The remainder of chapter will review monotonicity 
  calculus
  to show that we can extend the class of logics warranted by language
  beyond Aristotle's syllogisms (\refsec{natlog-mono}).
We will then give a practical introduction to using natural logic for practical NLP
  tasks (\refsec{natlog-nlp}), and
  motivate further research into related formalisms (\refsec{natlog-propositional}).
