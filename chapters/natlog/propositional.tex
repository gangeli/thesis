...
This is not accidental -- a key shortcoming of monotonicity calculus and modern natural
  logics is that by their very nature they operate on a single permise.
...
Furthermore, for simplicity, we will treat material implication axoimatically in terms of
...
In this section we propose an extension to propositional logic which uses monotonicity
  calculus to augment the semantics of these atomic propositions (conversly: an extension
