\Section{naturalli-results}{Experiments}
...
In order to err on the side of safety, we manually disallow deleting the verb
  \w{saw}.
...
This yielded a total of 305 million unique extractions composed
  ...
  (\num{186707} items) -- e.g., \ww{(cats; have; tails)}.
...
For negative examples, we take  689 ReVerb extractions
