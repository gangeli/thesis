\Section{naturalli-intro}{Introduction}
Now that we have covered the basics of natural logic, we turn our
...
For example, we would like to infer 
  ...
  (see \reffig{naturalli-teaser}).

\begin{figure}[th]
\begin{center}
  \teaserSearch
\end{center}
\longcaption{NaturalLI's natural logic inference cast as search.}
{
