\Section{qa-intro}{Introduction}

% Segue
We return to the NaturalLI system described in \refchp{naturalli}, and extend it
...
% Why natural logic
We present an approach that leverages the benefits of both methods.
...
(2) we augment NaturalLI with an evaluation function to provide an estimate of entailment
    for any query; and 
(3) we run our system over the Aristo science questions corpus \cite{key:2015clark-aristo},
