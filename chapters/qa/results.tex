...
\end{center}
% The caption
\longcaption{Accuracy of this thesis and prior work on the Aristo science questions dataset.}
{
...
% Evaluate NaturalLI
Last, we evaluate NaturalLI with the improvements presented in this chapter
...
In this chapter we have presented two theoretical improvements to natural logic inference to
