...
Our entailment classifier is designed to be as domain independent as possible;
  ...
  information retrieval system (in turn built upon Lucene).\footnote{
    Solr can be found online at \url{http://lucene.apache.org/solr/}.
  }
...
\end{tikzpicture}
\end{center}
\longcaption{An illustration of an alignment between a premise and a hypothesis for our QA system.}
{
\label{fig:alignment}
