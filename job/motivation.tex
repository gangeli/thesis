...
%%%%%%%%%%%%%%%%%%% 
\def\title{Why is Knowledge Important for the World?}
\begin{frame}{\title}
\begin{center}
  \includegraphics[height=3.0cm]{../img/google-now-voice.png} \\
  \vspace{2ex}
  \hh{More knowledge in the world than is found in Freebase} \\
\end{center}
\end{frame}
...
\begin{center}
  ...
  \vspace{2ex}
  \hh{800,000 biomedical articles published in 2013} \\
\end{center}
\end{frame}
...
\begin{center}
  ...
  \vspace{2ex}
  \hh{90\% of scientific papers never cited; perhaps never read} \\
\end{center}
\end{frame}
...
% Why is Knowledge Important
%%%%%%%%%%%%%%%%%%% 
\def\title{Why is Knowledge Important for NLP?}
\begin{frame}{\title}
\begin{center}
\textbf{\w{``The Good Dinosaur was \textcolor<3>{darkred}{Pixar} 's 
           \textcolor<4>{darkred}{second best} movie in 2015''}}
\end{center}
\pause
\vspace{1ex}
\hh{Why does a computer think this is positive?} \\
\vspace{1ex}
\pause
\pause
\pause
\hh{Why can humans interpret this review correctly?}
\begin{itemize}
...
\pause
\vspace{2ex}
\hh{Data gets you to $90\%$ accuracy -- knowledge for remaining $10\%$?} \\
\end{frame}
